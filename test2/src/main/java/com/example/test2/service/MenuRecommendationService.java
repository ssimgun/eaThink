...
public class MenuRecommendationService {
    ...
    public List<SurveyFood> getScoreByweather(HttpSession session, List<SurveyFood> personalFoodScore) {
        ...
        //snow
        List<String> snowHigh = Arrays.asList("삼겹살/목살", "유로피언레스토랑", "설렁탕/곰당/도가니탕", "바", "와인", "패밀리레스토랑", "동남아음식");
        ...
        List<String> fallFoods = Arrays.asList("맥주/호프", "전라도음식", "브런치", "바", "설렁탕/곰당/도가니탕", "동남아음식", "순두부");
        ...
        for (SurveyFood foodScore : personalFoodScore) {
            ...
            else if (formattedDateTime.equals("03") || formattedDateTime.equals("04") || formattedDateTime.equals("05")) {
                if (springFoods.contains(foodScore.getName())) {
                    foodScore.setWeatherScore(foodScore.getWeatherScore() + point);
                }
            }  // 24-7 사이의 가을
            else if (formattedDateTime.equals("09") || formattedDateTime.equals("10") || formattedDateTime.equals("11")) {
